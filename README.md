...
- **Featured carousel**: first slide can spotlight the **youngest app** in the configured “new” window (`app_age` via API). Remaining slides are unique picks by installs / totals / users — **each `.card` appears at most once**. Config: [`assets/js/script.js`](assets/js/script.js).