(function () {
  ...
  var T = {
    de: {
      ...
      trackerWebDesc: 'Verfolge deine Aktivität live direkt auf Google Maps — mit Garmin-Integration.',
    ...
    en: {
      ...
      trackerWebDesc: 'Follow your activity live directly on Google Maps — with Garmin integration.',
    ...
    es: {
      ...
      trackerWebDesc: 'Sigue tu actividad en vivo directamente en Google Maps — con integración Garmin.',
    ...
    fr: {
      ...
      trackerWebDesc: 'Suivez votre activité en direct sur Google Maps — avec intégration Garmin.',
    ...
    pt: {
      ...
      trackerWebDesc: 'Acompanhe sua atividade ao vivo diretamente no Google Maps — com integração Garmin.',
      trackerWebBtn: 'Abrir Rastreador →',
