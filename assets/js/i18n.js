(function () {
  ...
  var T = {
    de: {
      ...
      payGarmin: 'Garmin Pay',
      payGarminSub: 'Direkt auf der Uhr kaufen',
      payFastest: 'Am schnellsten',
      payOther: 'Weitere Zahlungsoptionen',
      payOtherSub: 'Karte, PayPal & mehr',
    ...
    en: {
      ...
      payGarmin: 'Garmin Pay',
      payGarminSub: 'Buy directly on your watch',
      payFastest: 'Fastest',
      payOther: 'More payment options',
      payOtherSub: 'Card, PayPal & more',
    ...
    es: {
      ...
      payGarmin: 'Garmin Pay',
      payGarminSub: 'Compra directamente en tu reloj',
      payFastest: 'Más rápido',
      payOther: 'Más opciones de pago',
      payOtherSub: 'Tarjeta, PayPal y más',
    ...
    fr: {
      ...
      payGarmin: 'Garmin Pay',
      payGarminSub: 'Achetez directement sur votre montre',
      payFastest: 'Le plus rapide',
      payOther: 'Autres options de paiement',
      payOtherSub: 'Carte, PayPal et plus',
    ...
    pt: {
      ...
      payGarmin: 'Garmin Pay',
      payGarminSub: 'Compre direto no seu relógio',
      payFastest: 'Mais rápido',
      payOther: 'Mais formas de pagamento',
      payOtherSub: 'Cartão, PayPal e mais',
