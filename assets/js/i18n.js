(function () {
  ...
  var T = {
    de: {
      ...
      payGarminSub: 'Das beste Erlebnis auf deiner Uhr',
      payRecommended: 'Empfohlen',
      payTrial: 'Kostenlos testen',
      payTrialSub: 'Karte, PayPal & mehr',
    ...
    en: {
      ...
      payGarmin: 'Garmin Pay',
      payGarminSub: 'The best experience on your watch',
      payRecommended: 'Recommended',
      payTrial: 'Free trial',
      payTrialSub: 'Card, PayPal & more',
    ...
    es: {
      ...
      payGarmin: 'Garmin Pay',
      payGarminSub: 'La mejor experiencia en tu reloj',
      payRecommended: 'Recomendado',
      payTrial: 'Prueba gratis',
      payTrialSub: 'Tarjeta, PayPal y más',
    ...
    fr: {
      ...
      payGarmin: 'Garmin Pay',
      payGarminSub: 'La meilleure expérience sur votre montre',
      payRecommended: 'Recommandé',
      payTrial: 'Essai gratuit',
      payTrialSub: 'Carte, PayPal et plus',
    ...
    pt: {
      ...
      payGarmin: 'Garmin Pay',
      payGarminSub: 'A melhor experiência no relógio',
      payRecommended: 'Recomendado',
      payTrial: 'Teste grátis',
      payTrialSub: 'Cartão, PayPal e outras formas',
